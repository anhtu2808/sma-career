    ...
    <div style={{ padding: "20px 32px", borderBottom: "1px solid #f0f0f0" }}>
      {jobDetail.skills && jobDetail.skills.length > 0 && (
        <div style={{ marginBottom: 12 }}>
          <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: "#6b7280", marginRight: 10 }}>Skills:</span>
          {jobDetail.skills.map(s => (
            <span key={s.id} style={{
              display: "inline-block", padding: "4px 14px", borderRadius: 6, fontSize: '0.8125rem',
      ...
      {jobDetail.expertise?.name && (
        <div style={{ marginBottom: 12 }}>
          <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: "#6b7280", marginRight: 10 }}>Job Expertise:</span>
          <span style={{
            display: "inline-block", padding: "4px 14px", borderRadius: 6, fontSize: '0.8125rem',
      ...
      {jobDetail.domains && jobDetail.domains.length > 0 && (
        <div>
          <span style={{ fontSize: '0.8125rem', fontWeight: 700, color: "#6b7280", marginRight: 10 }}>Job Domain:</span>
